...
from src.services.auto_crawler_service import generate_and_crawl_keywords
...
def main():
    ...
    parser.add_argument('--service', type=str, required=True,
                      choices=['crawl-data', 'reset-quota', 'crawl-video', 'crawl-comment', 'rabbitmq', 'kafka', 'kafka-channel', 'kafka-auto'],
                      help='Service to run')
    ...
    try:
        ...
        elif args.service == 'kafka-auto':
            logger.info("Starting generate and crawl keywords...")
            generate_and_crawl_keywords(args.num_keywords)
